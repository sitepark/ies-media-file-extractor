...
class ExtractorTest {
	...
	private static Stream<FileInfoTestParameter> createArguments() throws IOException {
		...
		for (String type : TYPES) {
			List<FileInfoTestParameter> typeArguments = createArguments(type);
	...
	private static List<FileInfoTestParameter> createArguments(String type) throws IOException {

		Path path = Paths.get("src/test/resources/files/" + type);
	...
	void createNewExpectedJsonFiles() throws IOException, ExtractionException {
		...
		for (String type : TYPES) {
			this.createNewExpectedJsonFiles(type);
		}
	}

	void createNewExpectedJsonFiles(String type) throws IOException, ExtractionException {
